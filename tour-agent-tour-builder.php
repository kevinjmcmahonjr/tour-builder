...
//     $tour_id = santitize_text_field( $_POST['tour_id'] );
...
function tour_builder_enqueue() {
    if (is_page('tour-builder')) {
        ...
        wp_enqueue_style( 'tour-builder-css', plugins_url('css/tour-builder-itinerary-module.css', __FILE__) );
        wp_enqueue_style( 'tour-builder-activity-css', plugins_url('css/tour-builder-activity-module.css', __FILE__) );
        ...
        wp_enqueue_script('tour-builder-module', plugins_url('js/tour-builder-itinerary-module.js', __FILE__), array( 'flatpickr', 'flatpickr-date-range', 'jquery-ui-core', 'jquery-ui-tabs' ), '', true);
        wp_enqueue_script('tour-builder-activity-module', plugins_url('js/tour-builder-activity-module.js', __FILE__), array( 'tour-builder-module' ), '', true);
        wp_enqueue_script('tour-builder-summary-generator', plugins_url('js/tour-builder-summary-generator.js', __FILE__), array( 'tour-builder-module', 'tour-builder-activity-module' ), '', true);
